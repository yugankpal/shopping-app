...
export class PreviewComponent implements OnInit {
  ...
  removeItems(id: any) {
    ...
    // let remainingList = this.allItems.filter(
    //   (item: any) => item.purchased === false
    // );
    // let remainingSelected = this.selected.filter(
    //   (item: any) => item.purchased === true
    // );
    // console.log(remainingList);

    // this.onLeftItems.emit({ remainingList, remainingSelected });
  }
